...
**How do I change the learning language?**
Use the language menu in the top-left of the Search, My Words, or Review tab. Switching changes the deck shown in My Words and Review accordingly.

**Will my saved cards sync to other devices?**
Not yet. Saved cards live on the device only. If you restore the device from an iCloud Backup, the cards come back as part of that backup.
...
**학습 언어를 어떻게 바꾸나요?**
검색 / 내 단어 / 학습 탭의 좌상단 언어 메뉴에서 바꿀 수 있습니다. 바꾸면 내 단어와 학습 화면이 해당 언어의 카드만 보여줍니다.

**저장한 카드가 다른 기기와 동기화되나요?**
현재는 지원하지 않습니다. 카드는 기기에만 저장됩니다. iCloud 백업으로 기기를 복원하면 백업의 일부로 복구됩니다.
